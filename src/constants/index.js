...
export const PROJECTS = [
  {
    ...
    image: project2,
    description:
      "The React Password Manager is a secure and user-friendly web application designed to help users store, manage, and organize their passwords. Built using React, this project emphasizes security.",
